...
class POEM_ON_STARTUP:
    ...
    @staticmethod
    def on_startup(logger: Logger, random: Random) -> None:
        """
...
class BASE_MARKER: # Base marker class that POTATO_MARKER and ARENA_MARKER derive from.
    team_marker_colors: dict[TEAM, tuple[int, int, int]] = { # Colour definitions for each team defined in TEAMS
    ...
    @property
    def bounding_box_color(self) -> tuple[int, int, int]: pass

class ARENA_MARKER(BASE_MARKER): # Not much going on here. This represents a wall.
    def __init__(self, id: int) -> None: pass
    def __repr__(self) -> str: pass
...
class MARKER(BASE_MARKER): # This is literally just how the code gets the different marker types.
    @staticmethod
    def by_id(id: int, team: (TEAM | None) = None) -> BASE_MARKER: # team is currently unused, but it is referenced throughout the code. It is the team of the robot I believe (check this)
        """
